CREATE OR REPLACE FUNCTION fn_gen_desc_1810 (p_description varchar2,p_afacctno varchar2,p_AMT number) return string
is
v_desc varchar2(500);
...
exception when others then
       return 'Cap han muc bao lanh cho tieu khoan';
end;
/
