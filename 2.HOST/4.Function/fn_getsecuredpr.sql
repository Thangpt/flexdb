...
BEGIN
    ...
    if p_PrTyp='P' then
            ...
            BEGIN
                select  greatest(sum(nvl(od.secureamt,0)-ci.balance-decode(l_isstopadv,'Y',0,NVL(adv.avladvance,0))),0) into l_PrSecured
                ...
                and nvl(od.secureamt,0)-ci.balance-decode(l_isstopadv,'Y',0,NVL(adv.avladvance,0))>0
