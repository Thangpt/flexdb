-- Start of DDL Script for Procedure HOSTMSTRADE.SP_BD_GETDEFFEERATE
-- Generated 11/04/2017 11:19:17 AM from HOSTMSTRADE@FLEX_111

CREATE OR REPLACE 
PROCEDURE sp_bd_getdeffeerate (PV_REFCURSOR IN OUT PKG_REPORT.REF_CURSOR,pv_ACCTNO varchar2, pv_EXECTYPE varchar2,pv_MatchType varchar2,pv_via varchar2, pv_PriceType varchar2, pv_Codeid varchar2)
is
    l_feerate number;
...
-- End of DDL Script for Procedure HOSTMSTRADE.SP_BD_GETDEFFEERATE
