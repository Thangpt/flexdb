...
ELSE
 ...
 SELECT custodycd,fullname,to_char(round(marginrate),'9,990.99')||' %' marginrate,to_char(ROUND(mrmrate))||' %' mrmrate, to_char (ROUND( CLAMT),'99G999G999G999G999MI')||' VND'CLAMT --thuyct edit to_char(round(marginrate)) 20191225
