...
insert into focmdcode (CMDCODE, CMDTEXT, CMDUSE, CMDTYPE, CMDDESC)
values ('fopks_ultilityApi.pr_ExternalTransfer', 'BEGIN fopks_ultilityApi.pr_ExternalTransfer(:accountid,:benefitbank,:benefitaccount,:benefitname,:benefitlisensecode,:amout,:feeamount,:vatamount,:transdescription,:ipaddress,:via,:validationtype,:devicetype,:device,:err_code,:err_msg); END;', 'Y', 'ultility', 'Chuyển tiền ra ngoài /externalTransfer');
insert into focmdcode (CMDCODE, CMDTEXT, CMDUSE, CMDTYPE, CMDDESC)
values ('fopks_ultilityApi.pr_InternalTransfer', 'BEGIN fopks_ultilityApi.pr_InternalTransfer(:accountid,:receiveaccount,:amout,:transdescription,:ipaddress,:via,:validationtype,:devicetype,:device,:err_code,:err_msg); END;', 'Y', 'ultility', 'Chuyển tiền nội bộ /internalTransfer');
insert into focmdcode (CMDCODE, CMDTEXT, CMDUSE, CMDTYPE, CMDDESC)
values ('fopks_ultilityApi.pr_Depoacc2Transfer', 'BEGIN fopks_ultilityApi.pr_Depoacc2Transfer(:custid,:acctno,:ccustodycd,:cacctno,:amount,:err_code,:err_msg,:ipaddress,:via,:validationtype,:devicetype,:device,:desc); END;', 'Y', 'ultility', 'Chuyển tiền giữa 2 tài khoản lưu ký');
insert into focmdcode (CMDCODE, CMDTEXT, CMDUSE, CMDTYPE, CMDDESC)
values ('fopks_ultilityApi.pr_advanced', 'BEGIN fopks_ultilityApi.pr_advanced(:accountid,:txdate,:paidDate,:advanceamt,:feeAmt,:days,:advancedMaxAmt,:desc,:ipaddress,:via,:validationtype,:devicetype,:device,:err_code,:err_msg); END;', 'Y', 'ultility', 'Thực hiện ứng trước /advanced');
insert into focmdcode (CMDCODE, CMDTEXT, CMDUSE, CMDTYPE, CMDDESC)
...
insert into focmdcode (CMDCODE, CMDTEXT, CMDUSE, CMDTYPE, CMDDESC)
values ('fopks_ultilityApi.pr_rightOffRegiter', 'BEGIN fopks_ultilityApi.pr_rightOffRegiter(:accountid,:camastid,:qtty,:desc,:ipaddress,:via,:validationtype,:devicetype,:device,:err_code,:err_msg); END;', 'Y', 'ultility', 'Đăng kí mua CK sự kiện quyền /rightOffRegiter');
insert into focmdcode (CMDCODE, CMDTEXT, CMDUSE, CMDTYPE, CMDDESC)
...
insert into focmdcode (CMDCODE, CMDTEXT, CMDUSE, CMDTYPE, CMDDESC)
values ('fopks_reportapi.pr_GetConfirmOrderHist', 'BEGIN fopks_reportapi.pr_GetConfirmOrderHist(:ret,:custid,:accountid,:err_code,:err_msg); END;', 'Y', 'report', 'tra c?u danh sách xác nh?n l?nh');
insert into focmdcode (CMDCODE, CMDTEXT, CMDUSE, CMDTYPE, CMDDESC)
values ('fopks_ultilityApi.pr_Bonds2SharesRegister', 'BEGIN fopks_ultilityApi.pr_Bonds2SharesRegister(:accountid,:caSchId,:quantity,:desc,:ipaddress,:via,:validationtype,:devicetype,:device,:err_code,:err_msg); END;', 'Y', 'reg', 'Đăng ký chuyển đổi trái phiếu');
insert into focmdcode (CMDCODE, CMDTEXT, CMDUSE, CMDTYPE, CMDDESC)
values ('fopks_ultilityApi.pr_confirmOrder', 'BEGIN fopks_ultilityApi.pr_confirmOrder(:accountid,:custid,:orderId,:ipaddress,:via,:err_code,:err_msg); END;', 'Y', 'reg', 'Giao dịch thực hiện xác nhận lệnh');
insert into focmdcode (CMDCODE, CMDTEXT, CMDUSE, CMDTYPE, CMDDESC)
...
insert into focmdcode (CMDCODE, CMDTEXT, CMDUSE, CMDTYPE, CMDDESC)
values ('fopks_ultilityApi.pr_registTransferAcct', 'BEGIN fopks_ultilityApi.pr_registTransferAcct(:accountId,:bankAcName,:bankAcc,:bankName,:bankId,:bankOrgNo,:branch,:city,:hintName,:ipAddress,:via,:validationtype,:devicetype,:device,:err_code,:err_msg); END;', 'Y', 'reg', 'Đăng ký người thụ hưởng');
insert into focmdcode (CMDCODE, CMDTEXT, CMDUSE, CMDTYPE, CMDDESC)
...
insert into focmdcode (CMDCODE, CMDTEXT, CMDUSE, CMDTYPE, CMDDESC)
values ('fopks_api.pr_updatepasspinonline', 'BEGIN fopks_api.pr_updatepasspinonline(:username,:password,:pin,:err_code,:err_msg,:via); END;', 'Y', 'account', 'Ð?i m?t kh?u và pin d?ng th?i');
insert into focmdcode (CMDCODE, CMDTEXT, CMDUSE, CMDTYPE, CMDDESC)
...
insert into focmdcode (CMDCODE, CMDTEXT, CMDUSE, CMDTYPE, CMDDESC)
values ('fopks_openapi.fn_check_system_active', 'select fopks_openapi.fn_check_system_active from dual', 'Y', 'report', 'Tr?ng thái DB');
insert into focmdcode (CMDCODE, CMDTEXT, CMDUSE, CMDTYPE, CMDDESC)
...
insert into focmdcode (CMDCODE, CMDTEXT, CMDUSE, CMDTYPE, CMDDESC)
values ('pr_insertlogplaceorder', 'BEGIN pr_insertlogplaceorder(:requestId,:orderId,:via,:ipAddress,:validationType,:deviceType,:device); END;', 'Y', 'report', 'Ghi log đặt lệnh');
insert into focmdcode (CMDCODE, CMDTEXT, CMDUSE, CMDTYPE, CMDDESC)
values ('fopks_openapi.pr_get_customer_info', 'BEGIN fopks_openapi.pr_get_customer_info(:ret,:custid,:err_code,:err_msg); END;', 'Y', 'report', 'Thông tin tài khoản');
insert into focmdcode (CMDCODE, CMDTEXT, CMDUSE, CMDTYPE, CMDDESC)
...
insert into focmdcode (CMDCODE, CMDTEXT, CMDUSE, CMDTYPE, CMDDESC)
values ('fds_broker_api.fds_HistoryVIMCash', 'BEGIN fopks_reportapi.pr_getHistoryVIMCash(:ret,:custodycd,:accountId,:fromDate,:toDate); END;', 'Y', 'report', 'Lịch sử giao dịch tài khoản ký quỹ');
insert into focmdcode (CMDCODE, CMDTEXT, CMDUSE, CMDTYPE, CMDDESC)
values ('fopks_reportapi.pr_getCashOnHandHist', 'BEGIN fopks_reportapi.pr_getCashOnHandHist(:ret,:accountId,:fromDate,:toDate); END;', 'Y', 'report', 'Lịch sử giao dịch tiền tài khoản công ty');
insert into focmdcode (CMDCODE, CMDTEXT, CMDUSE, CMDTYPE, CMDDESC)
...
insert into focmdcode (CMDCODE, CMDTEXT, CMDUSE, CMDTYPE, CMDDESC)
values ('fds_broker_api.PR_PROCESSDT17', 'BEGIN fds_broker_api.PR_PROCESSDT17(:tlId,:accountId,:amount,:desc,:err_code,:err_msg,:ipaddress,:via,:validationType,:deviceType,:device); END;', 'Y', 'report', 'Tất toán nợ thấu chi - Submit');
insert into focmdcode (CMDCODE, CMDTEXT, CMDUSE, CMDTYPE, CMDDESC)
...
insert into focmdcode (CMDCODE, CMDTEXT, CMDUSE, CMDTYPE, CMDDESC)
values ('fds_broker_api.fds_getcustomersummary', 'BEGIN fds_broker_api.fds_getcustomersummary(:ret,:dmacctno,:dtaacctno); END;', 'Y', 'report', 'Lấy tiền rút tối đa');
insert into focmdcode (CMDCODE, CMDTEXT, CMDUSE, CMDTYPE, CMDDESC)
...
insert into focmdcode (CMDCODE, CMDTEXT, CMDUSE, CMDTYPE, CMDDESC)
values ('FN_GET_TRANSACTION_CODE', 'SELECT VALUECD, DISPLAY, EN_DISPLAY  FROM ( SELECT TLTXCD VALUECD, TLTXCD VALUE, TXDESC DISPLAY, EN_TXDESC EN_DISPLAY, EN_TXDESC DESCRIPTION FROM TLTX WHERE TLTXCD LIKE ''D%'' AND TLTXCD NOT LIKE ''DF%''  UNION ALL SELECT ''ALL'', ''ALL'', ''ALL'', ''ALL'', ''ALL'' FROM DUAL  ) ORDER BY DISPLAY', 'Y', 'report', 'Mã giao dịch');
insert into focmdcode (CMDCODE, CMDTEXT, CMDUSE, CMDTYPE, CMDDESC)
values ('fds_cspks_dtproc.pr_getppse', 'BEGIN fds_cspks_dtproc.pr_getppse(:ret,:accountId,:symbol,:quoteprice,:via); END;', 'Y', 'report', 'Số lượng mua bán tối đa');
insert into focmdcode (CMDCODE, CMDTEXT, CMDUSE, CMDTYPE, CMDDESC)
values ('fds_broker_api.pr_ConfirmOrder', 'BEGIN fds_broker_api.pr_ConfirmOrder(:orderId,:custid,:via,:ipAddress,:validationType,:deviceType,:device,:err_code,:err_msg,:tlid); END;', 'Y', 'trans', 'Xác nhận lệnh');
insert into focmdcode (CMDCODE, CMDTEXT, CMDUSE, CMDTYPE, CMDDESC)
values ('fds_broker_api.pr_GetConfirmOrderHist', 'BEGIN fds_broker_api.pr_GetConfirmOrderHist(:ret,:custodycd,:accountId,:fromDate,:toDate,:execType,:pagerpp,:rowsrpp); END;', 'Y', 'report', 'Danh sách lệnh chưa xác nhận lệnh');
insert into focmdcode (CMDCODE, CMDTEXT, CMDUSE, CMDTYPE, CMDDESC)
...
insert into focmdcode (CMDCODE, CMDTEXT, CMDUSE, CMDTYPE, CMDDESC)
values ('fopks_openapi.pr_delete_orders', 'BEGIN fopks_openapi.pr_delete_orders(:accountid,:orderid,:username,:ipaddress,:via,:err_code,:err_msg); END;', 'Y', 'orders', 'Function delete orders');
insert into focmdcode (CMDCODE, CMDTEXT, CMDUSE, CMDTYPE, CMDDESC)
...
insert into focmdcode (CMDCODE, CMDTEXT, CMDUSE, CMDTYPE, CMDDESC)
values ('fopks_openapi.pr_post_orders', 'BEGIN fopks_openapi.pr_post_orders(:accountid,:requestid,:username,:instrument,:qty,:side,:type,:limitprice,:stopprice,:durationtype,:durationdatetime,:stoploss,:takeprofit,:digitalsignature,:ipaddress,:via,:orderid,:err_code,:err_msg); END;', 'Y', 'orders', 'Tạo lệnh');
insert into focmdcode (CMDCODE, CMDTEXT, CMDUSE, CMDTYPE, CMDDESC)
values ('fopks_openapi.pr_put_orders', 'BEGIN fopks_openapi.pr_put_orders(:accountid,:orderid,:username,:qty,:limitprice,:stopprice,:stoploss,:takeprofit,:digitalsignature,:ipaddress,:via,:err_code,:err_msg); END;', 'Y', 'orders', 'Sửa lệnh');
insert into focmdcode (CMDCODE, CMDTEXT, CMDUSE, CMDTYPE, CMDDESC)
...
insert into focmdcode (CMDCODE, CMDTEXT, CMDUSE, CMDTYPE, CMDDESC)
values ('fds_broker_api.pr_checkIMbalance', 'BEGIN fds_broker_api.pr_checkIMbalance(:ret,:accountId,:amount,:iorofee,:typecd,:err_code); END;', 'Y', 'reg', 'Check nop rut tien ky quy');
insert into focmdcode (CMDCODE, CMDTEXT, CMDUSE, CMDTYPE, CMDDESC)
values ('FN_GET_FDSSYSCFG', 'SELECT cfgvalue FROM fdssysconfig WHERE (CFGKEY=:cfgkey)', 'Y', 'config', 'Lấy tham số trong bảng fdssysconfig');
commit;
/
