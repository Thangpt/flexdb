...
INSERT INTO DEFERROR (ERRNUM,ERRDESC,EN_ERRDESC,MODCODE,CONFLVL)
VALUES (-200127,'[-200127]: PIN hiện tại không đúng!','[-200127]: PIN hiện tại không đúng!','CF',null);
INSERT INTO DEFERROR (ERRNUM,ERRDESC,EN_ERRDESC,MODCODE,CONFLVL)
VALUES (-200126,'[-200126]: Xác nhận PIN không khớp!','[-200126]: Xác nhận PIN không khớp!','CF',null);
INSERT INTO DEFERROR (ERRNUM,ERRDESC,EN_ERRDESC,MODCODE,CONFLVL)
...
INSERT INTO DEFERROR (ERRNUM,ERRDESC,EN_ERRDESC,MODCODE,CONFLVL)
VALUES (-200114,'[-200114]: Định dạng số điện thoại không hợp lệ.','[-200114]: MobilePhone Invalid','CF',null);
COMMIT;
/
