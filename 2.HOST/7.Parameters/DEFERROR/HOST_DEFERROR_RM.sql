...
INSERT INTO DEFERROR (ERRNUM,ERRDESC,EN_ERRDESC,MODCODE,CONFLVL)
VALUES (-660001,'Trạng thái ngân hàng không hợp lệ','Bank status invalid','RM',0);
INSERT INTO DEFERROR (ERRNUM,ERRDESC,EN_ERRDESC,MODCODE,CONFLVL)
VALUES (-660002,'Tài khoản không thể kết nối với ngân hàng','Account cannot connect to bank!','RM',0);
INSERT INTO DEFERROR (ERRNUM,ERRDESC,EN_ERRDESC,MODCODE,CONFLVL)
VALUES (-660003,'Đứt kết nối tới ngân hàng','Cannot connect to bank','RM',0);
INSERT INTO DEFERROR (ERRNUM,ERRDESC,EN_ERRDESC,MODCODE,CONFLVL)
VALUES (-660004,'Trạng thái thay đổi không đúng','Cannot revert bank status','RM',null);
INSERT INTO DEFERROR (ERRNUM,ERRDESC,EN_ERRDESC,MODCODE,CONFLVL)
VALUES (-660005,'Tài khoản Offline của ngân hàng không tìm thấy','Ofline bank account not found','RM',0);
INSERT INTO DEFERROR (ERRNUM,ERRDESC,EN_ERRDESC,MODCODE,CONFLVL)
VALUES (-660006,'Số dư không đủ để phong tỏa','BALANCE NOT ENOUGH TO BLOCK','RM',0);
INSERT INTO DEFERROR (ERRNUM,ERRDESC,EN_ERRDESC,MODCODE,CONFLVL)
VALUES (-660007,'Số dư không đủ để giải tỏa','BALANCE NOT ENOUGH TO UNBLOCK','RM',0);
INSERT INTO DEFERROR (ERRNUM,ERRDESC,EN_ERRDESC,MODCODE,CONFLVL)
VALUES (-660008,'Số tiền phải là kiểu số','AMOUNT IS NOT NUMBER','RM',0);
INSERT INTO DEFERROR (ERRNUM,ERRDESC,EN_ERRDESC,MODCODE,CONFLVL)
VALUES (-660009,'Ngày bắt đầu không đúng định dạng','BEGIN DATE TYPE INVALID','RM',0);
INSERT INTO DEFERROR (ERRNUM,ERRDESC,EN_ERRDESC,MODCODE,CONFLVL)
VALUES (-660010,'Ngày kết thúc không đúng định dạng','End date type invalid','RM',0);
INSERT INTO DEFERROR (ERRNUM,ERRDESC,EN_ERRDESC,MODCODE,CONFLVL)
