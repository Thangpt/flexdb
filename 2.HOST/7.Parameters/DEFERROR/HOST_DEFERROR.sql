...
--
/
DELETE DEFERROR WHERE MODCODE = null;
...
INSERT INTO DEFERROR (ERRNUM,ERRDESC,EN_ERRDESC,MODCODE,CONFLVL)
VALUES (-180046,'[-180046]: Loại hình vay T0 phải để tham số nguồn công ty và không tuân thủ hệ thống!','[-180046]: T0 type of loan to the company to take the source and does not comply with the system !',null,null);
INSERT INTO DEFERROR (ERRNUM,ERRDESC,EN_ERRDESC,MODCODE,CONFLVL)
