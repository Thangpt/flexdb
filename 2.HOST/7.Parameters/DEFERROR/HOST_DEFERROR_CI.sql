...
INSERT INTO DEFERROR (ERRNUM,ERRDESC,EN_ERRDESC,MODCODE,CONFLVL)
VALUES (-4000022,'[-4000022]: Phí ngoài bắt buộc nhập biểu phí!','[-4000022]: Out fee in addition to the compulsory tariff','CI',null);
insert into deferror (ERRNUM, ERRDESC, EN_ERRDESC, MODCODE, CONFLVL)
values (-400126, '[-400126]: Trạng thái yêu cầu không hợp lệ!', '[-400126]: Request status invalid!', 'CI', null);
insert into deferror (ERRNUM, ERRDESC, EN_ERRDESC, MODCODE, CONFLVL)
values (-400050, '[-400050]:Số tiền chuyển phải nhỏ hơn hạn mức chuyển tiền tối đa!', '[-400050]:Số tiền chuyển phải nhỏ hơn hạn mức chuyển tiền tối đa!', 'CI', null);
insert into deferror (ERRNUM, ERRDESC, EN_ERRDESC, MODCODE, CONFLVL)
values (-400049, '[-400049]:Diễn giải phải nhỏ hơn 250 ký tự và không chứa ký tự đặc biệt!', '[-400049]:Diễn giải phải nhỏ hơn 250 ký tự và không chứa ký tự đặc biệt!', 'CI', null);
COMMIT;
/
