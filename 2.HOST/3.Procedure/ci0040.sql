...
-- GET REPORT'S DATA
      ...
      FOR
         ...
         FROM   AFMAST AF, CFMAST CF, (SELECT * FROM CIINTTRAN UNION ALL SELECT * FROM CIINTTRANA) CIT
         WHERE  AF.CUSTID        =   CF.CUSTID
         AND    AF.ACCTNO        =   CIT.ACCTNO
         AND    CIT.INTTYPE      =   'CR'
         AND    CIT.TODATE       BETWEEN V_FROMDATE AND V_TODATE
         AND af.brid LIKE V_I_BRIDGD
