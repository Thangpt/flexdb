-- Start of DDL Script for Procedure HOSTMSTRADE.OD0067
-- Generated 17/04/2017 11:33:00 AM from HOSTMSTRADE@FLEX_111
...
BEGIN
   ...
   ELSIF CASHPLACE = '000' Then
       v_CashPlaceName := ' C?ng ty ch?ng kho?';
   Else
       Begin
   ...
   END IF;
    ...
    select getduedate(TO_DATE (i_date, 'DD/MM/YYYY'), 'B', '000', v_clearday) into V_cleardate from dual;
...
-- End of DDL Script for Procedure HOSTMSTRADE.OD0067
