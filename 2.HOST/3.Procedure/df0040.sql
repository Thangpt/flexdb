...
select  case when main.nguon_giai_ngan = 'B' then nvl(lm.amt,lm.lmamt)
       ...
       (case when main.nguon_giai_ngan = 'B' then nvl(lm.amt,lm.lmamt)
        ...
        main.afacctno, main.rrtype cdcontent, main.actype, main.custodycd, main.fullname , main.grpname,
...
from (SELECT * FROM dfgroup UNION ALL SELECT * FROM dfgrouphist) dg, cfmast cf, afmast af,
    (Select * from dfmast union all select * from dfmasthist) df, tlgroups tl, dftype, cfmast cfbank, lnmast -- allcode a1,
...
group by  tl.grpname, cfbank.fullname, dftype.actype, cf.custodycd, dg.afacctno, cf.fullname, dg.groupid, dg.custbank,dg.rrtype,  af.mrcrlimitmax
) main
left join
...
group by  main.afacctno, main.rrtype, main.actype, main.custodycd, main.fullname,main.nguon_giai_ngan, main.grpname, nvl(lm.amt,lm.lmamt), main.mrcrlimitmax
