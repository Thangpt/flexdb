...
from
    ...
    select od.clearday, (case when od.exectype = 'NB' then '8865' else '8866' end) des,
        ...
        (case when (case when od.exectype = 'NB' then sts.trfbuydt else sts.cleardate end) = V_T0_DATE
            then od.execamt else 0 end) amt_T0,
        (case when (case when od.exectype = 'NB' then sts.trfbuydt else sts.cleardate end) = V_T1_DATE
            then od.execamt else 0 end) amt_T1,
        (case when (case when od.exectype = 'NB' then sts.trfbuydt else sts.cleardate end) = V_T2_DATE
            then od.execamt else 0 end) amt_T2,
        (case when (case when od.exectype = 'NB' then sts.trfbuydt else sts.cleardate end) = V_T3_DATE
    ...
    select od.clearday, '0066' des,
        (case when sts.cleardate = V_T0_DATE then
            (CASE WHEN aft.vat = 'Y' then od.taxsellamt else 0 end) else 0 end ) amt_T0,
        (case when sts.cleardate = V_T1_DATE then
            (CASE WHEN aft.vat = 'Y' then od.taxsellamt else 0 end) else 0 end ) amt_T1,
        (case when sts.cleardate = V_T2_DATE then
            (CASE WHEN aft.vat = 'Y' then od.taxsellamt else 0 end) else 0 end ) amt_T2,
        (case when sts.cleardate = V_T3_DATE then
            (CASE WHEN aft.vat = 'Y' then od.taxsellamt else 0 end) else 0 end ) amt_T3
