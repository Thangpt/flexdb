...
FOR
    ...
    and case when I_BANKNAME = 'ALL' then 1
                when I_BANKNAME = 'KBSV' and LN.rrtype = 'C' then 1
    ...
    -- begin ver: 1.5.0.2 | iss: 1692
    --AND LS.NML+LS.OVD - NVL(LNTR.PRIN_MOVE,0) > 0
    AND(LS.NML+LS.OVD - NVL(LNTR.PRIN_MOVE,0) > 0 OR 
        LS.INTNMLACR+LS.INTDUE+LS.INTOVD+LS.INTOVDPRIN-NVL(LNTR.INT_MOVE,0) > 0)
    -- end ver: 1.5.0.2 | iss: 1692
