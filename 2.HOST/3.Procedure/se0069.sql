CREATE OR REPLACE PROCEDURE se0069 (
...
-- RP NAME : Bang ke danh sach VSD tu choi luu ky CK
-- PERSON : PhucPP
-- DATE : 15/02/2012
...
-- GET REPORT'S DATA
 ...
 FOR
       ...
       CASE WHEN CF.CUSTODYCD LIKE '%F%'  THEN CF.TRADINGCODEDT WHEN CF.CUSTODYCD LIKE '%P%'  THEN CF.TRADINGCODEDT ELSE CF.IDDATE END IDDATE,
       CASE WHEN CF.CUSTODYCD LIKE '%F%'  THEN '2' WHEN CF.CUSTODYCD LIKE '%P%'  THEN '3' WHEN CF.CUSTODYCD LIKE '%C%' AND CF.CUSTTYPE = 'B'  THEN '3' ELSE '1' END IDTYPE,
       SB.CODEID, SB.PARVALUE, TL.KL QTTY_R, CASE WHEN RF.SYMBOL_R like '%WFT%' THEN sb.symbol ELSE ISS.FULLNAME END TEN_CK,
