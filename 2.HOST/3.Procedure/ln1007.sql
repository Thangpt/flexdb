CREATE OR REPLACE PROCEDURE ln1007 (
...
BEGIN
    ...
    OPEN PV_REFCURSOR FOR
       ...
       , greatest(case when a.rrtype = 'B' then 20000000000 else 0 end -  sum(a.lnprin) ,0)  ham_muc_con_duoc_dung
        FROM
        (
       ...
       , case when a.rrtype = 'B' then 20000000000 else 0 end
