CREATE OR REPLACE PROCEDURE cf9009 (
...
-- BAO CAO phong toa chung khoan am tien
-- MODIFICATION HISTORY
-- PERSON       DATE                COMMENTS
-- ---------   ------  -------------------------------------------
-- DUONG.TT        08-10-2010           CREATED
--
...
if v_CustodyCD = 'ALL' or v_CustodyCD is null then --kiem tra data input ALL
   v_CustodyCD := '%';
else
...
where cf.custodycd like v_CustodyCD
    and exists (select gu.grpid from tlgrpusers gu where cf.careby = gu.grpid and gu.tlid = TLID)   -- check careby
    and
    (
