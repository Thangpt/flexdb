...
OPEN PV_REFCURSOR
FOR
    select ' ' fullname, '005', 'N' custodycd, ' ' idcode, ' ' address, to_date('01-Jan-2222','DD/MM/RRRR') Iddate,
            ' ' idplace, 'CN' CUSTTYPE_NAME,
            to_date('01-Jan-2222','DD/MM/RRRR') OPNDATE, ' ' Country_name, V_BRNAME BRNAME from dual
    union all
    select ' ' fullname, '005', 'N' custodycd, ' ' idcode, ' ' address, to_date('01-Jan-2222','DD/MM/RRRR') Iddate,
            ' ' idplace, 'TC' CUSTTYPE_NAME,
            to_date('01-Jan-2222','DD/MM/RRRR') OPNDATE, ' ' Country_name, V_BRNAME BRNAME from dual
    union all
