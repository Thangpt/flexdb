CREATE OR REPLACE PROCEDURE HDTKDV (
...
FOR
    ...
    re.bankaccountnumber1,re.bankname1,re.branch1,re.otheraccount1, re.othercompany1,
    re.customerbirth, re.taxcode, re.registerservices, re.registernotitran,
    re.authentypeonline, re.authentypemobile, re.areaopenaccount, re.branchopenaccount
