...
SELECT TL.BUSDATE ,cf.custodycd ,af.acctno ,cf.fullname ,tl.msgamt FROM  vw_tllog_all tl,afmast af ,CFMAST CF
where tl.msgacct = af.acctno
and tl.deltd <> 'Y' and af.custid = cf.custid and tltxcd ='1137'
