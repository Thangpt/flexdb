...
begin
    ...
    plog.error('pr_view_ln9000 l_gTellerID:'||l_gTellerID);
    plog.error('pr_view_ln9000 l_BANKSHORTNAME:'||l_BANKSHORTNAME);
    plog.error('pr_view_ln9000 l_LOANTYPE:'||l_LOANTYPE);
    plog.error('pr_view_ln9000 p_FROM_ROW:'||p_FROM_ROW);
    plog.error('pr_view_ln9000 p_TO_ROW:'||p_TO_ROW);
