CREATE OR REPLACE PROCEDURE sp_bd_getsemastposition(PV_REFCURSOR IN OUT PKG_REPORT.REF_CURSOR, AFACCTNO IN VARCHAR2)
  IS
...
BEGIN
    ...
    SELECT V_PARAFILTER SUBACCTNO,SB.SYMBOL, MAX(MST.TRADE+MST.MORTAGE+MST.BLOCKED+MST.NETTING+MST.WTRADE) TOTAL_QTTY,
    ...
    WHERE MST.AFACCTNO=AF.ACCTNO AND AF.CUSTID=CF.CUSTID AND MST.CODEID=SB.CODEID AND AF.ACCTNO=V_PARAFILTER
