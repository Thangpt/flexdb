-- Start of DDL Script for Procedure HOSTMSTRADE.OD1019
-- Generated 11/04/2017 3:14:50 PM from HOSTMSTRADE@FLEX_111
...
select to_char(sts.txdate,'mm/yyyy') txdate ,
      sum( CASE WHEN SB.sectype IN ('001','011') AND STS.TRADEPLACE ='001' AND  SUBSTR(STS.afacctno,1,2)='00' and od.matchtype ='N' THEN STS.amt ELSE 0 END) HS_CP_HSX_N,
      sum( CASE WHEN SB.sectype IN ('001','011') AND STS.TRADEPLACE ='001' AND  SUBSTR(STS.afacctno,1,2)='01' and od.matchtype ='N' THEN STS.amt ELSE 0 END) CN_CP_HSX_N,
      sum( CASE WHEN SB.sectype IN ('001','011') AND STS.TRADEPLACE ='001' and od.matchtype ='N' THEN STS.amt ELSE 0 END) CT_CP_HSX_N,
      sum( CASE WHEN SB.sectype IN ('001','011') AND STS.TRADEPLACE ='001' AND  SUBSTR(STS.afacctno,1,2)='00' and od.matchtype ='P' THEN STS.amt ELSE 0 END) HS_CP_HSX_P,
      sum( CASE WHEN SB.sectype IN ('001','011') AND STS.TRADEPLACE ='001' AND  SUBSTR(STS.afacctno,1,2)='01' and od.matchtype ='P' THEN STS.amt ELSE 0 END) CN_CP_HSX_P,
      sum( CASE WHEN SB.sectype IN ('001','011') AND STS.TRADEPLACE ='001' and od.matchtype ='P' THEN STS.amt ELSE 0 END) CT_CP_HSX_P,
      ...
      sum( CASE WHEN SB.sectype IN ('001','011') AND STS.TRADEPLACE ='002' AND  SUBSTR(STS.afacctno,1,2)='00'  THEN STS.amt ELSE 0 END) HS_CP_HNX,
      sum( CASE WHEN SB.sectype IN ('001','011') AND STS.TRADEPLACE ='002' AND  SUBSTR(STS.afacctno,1,2)='01'  THEN STS.amt ELSE 0 END) CN_CP_HNX,
      sum( CASE WHEN SB.sectype IN ('001','011') AND STS.TRADEPLACE ='002'  THEN STS.amt ELSE 0 END) CT_CP_HNX,
...
-- End of DDL Script for Procedure HOSTMSTRADE.OD1019
