CREATE OR REPLACE PROCEDURE DF9904 (
...
SELECT DF.ACCTNO, CF.CUSTODYCD, CF.FULLNAME, LN.RLSDATE OPNDATE, SB.SYMBOL,Df.Afacctno,df.refprice,
    ...
    Df.Description, Trall.Txnum, Typ.Actype, Tlgroups.Grpname Careby,Tl.Tlname Nguoiquanly,
     tl1.tlname NguoiThucHien,tl2.tlname NguoiDuyet,(DF.Dfqtty + DF.Rcvqtty + DF.Blockqtty + DF.Carcvqtty) SL_CONLAI
...
/*    (
    ...
    ) TRALL,tlgroups,tlprofiles tl,vw_tllog_all la,tlprofiles tl1,tlprofiles tl2
