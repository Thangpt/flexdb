CREATE OR REPLACE PROCEDURE ci1018_bk1104(
...
union ALL
SELECT   tl.tltxcd ,tl.txdesc/*tltx.txdesc*/ ,tl.txnum,tl.busdate ,tl.txdate,cf.custodycd,af.acctno, '' custodycdc,'' acctnoc,ci.NAMT amt,nvl(mk.tlname,'') mk,nvl(ck.tlname,'')  ck,nvl(tl.brid,'') brid,nvl(tl.tlid,'') tlid,nvl(tl.OFFID,'') OFFID,
nvl(CFB.shortname,'') bankid ,af.corebank,decode(af.bankname,'---',utf8nums.c_const_COMPANY_NAME,af.bankname) bankname,ci.trdesc, ci.txtype
FROM vw_tllog_all TL,afmast af,cfmast cf ,--tltx,
