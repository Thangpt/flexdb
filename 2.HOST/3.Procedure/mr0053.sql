...
BEGIN
    ...
    OPEN PV_REFCURSOR FOR
        SELECT LN.*, NVL(CFL.LMAMTMAX,0) LIMITAMT, NVL(CF.FULLNAME,'KBSV') BANKNAME, V_IN_DATE IN_DATE
        FROM
        (   -- DF - CAM CO
            SELECT NVL(LN.CUSTBANK,'KBSV') CUSTBANK, LN.RRTYPE, LN.FTYPE,
            ...
            UNION ALL
            -- MR - MARGIN
            SELECT NVL(LN.CUSTBANK,'KBSV') CUSTBANK, LN.RRTYPE, 'AF' FTYPE,
                SUM(LN.PRINNML + LN.PRINOVD) RLSAMT, LN.ACTYPE
            FROM LNMAST LN
            ...
            SELECT NVL(LN.CUSTBANK,'KBSV') CUSTBANK, LN.RRTYPE, 'GR' FTYPE,
            ...
            SELECT NVL(AD.CUSTBANK,'KBSV') CUSTBANK, AD.RRTYPE, 'AD' FTYPE,
        ...
        WHERE LN.RLSAMT > 0
            ...
            AND CASE WHEN LN.CUSTBANK = 'KBSV' THEN '--' ELSE DECODE(LN.FTYPE,'AD','ADV','DFMR') END = CFL.LMSUBTYPE (+)
