   ...
   BEGIN
      ...
      IN (SELECT DISTINCT r.tblname tblname, c.fldkey fldkey, c.acfld acfld, c.isrun isrun
          ...
          WHERE     TRIM (c.apptype) = TRIM (r.apptype)
                ...
                AND tltxcd = p_tltxcd and r.tblname not in ('SEWITHDRAW','DFMAST','RPMAST','SBGROUP','SBMAST','CAMAST'))
      LOOP
   ...
   BEGIN
      ...
      ELSE
         l_source_proc   :=
            ...
            || '   END IF;';
      END IF;
plog.error('LINH1:'||length(l_source_proc));
      l_source_proc   :=
            l_source_proc
         || CHR (10)
   ...
   BEGIN
      ...
      loop
          ...
          l_allpks:=l_allpks || CHR(10) || l_pks;
      end loop;
