   ...
   IF p_txmsg.deltd <> 'Y' THEN -- Normal transaction
      ...
      UPDATE CIMAST
         SET
           ...
           BALANCE = BALANCE - (ROUND(p_txmsg.txfields('76').value+p_txmsg.txfields('79').value+p_txmsg.txfields('71').value+p_txmsg.txfields('73').value,0)) - (ROUND(p_txmsg.txfields('60').value+p_txmsg.txfields('61').value+p_txmsg.txfields('62').value,0)) - (ROUND(p_txmsg.txfields('82').value+p_txmsg.txfields('70').value+p_txmsg.txfields('75').value+p_txmsg.txfields('78').value+p_txmsg.txfields('77').value+p_txmsg.txfields('80').value+p_txmsg.txfields('72').value+p_txmsg.txfields('74').value,0)) - (ROUND(p_txmsg.txfields('57').value+p_txmsg.txfields('50').value+p_txmsg.txfields('52').value,0)) - (ROUND(p_txmsg.txfields('54').value,0)) - (ROUND(p_txmsg.txfields('63').value+p_txmsg.txfields('64').value+p_txmsg.txfields('65').value,0)),
