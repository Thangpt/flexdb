...
plog.setbeginsection (pkgctx, 'fn_txAppAutoCheck');
     ...
     If txpks_check.fn_aftxmapcheck(p_txmsg.txfields('23').value,'SEMAST','23','2245')<>'TRUE' then
     ...
     If txpks_check.fn_aftxmapcheck(p_txmsg.txfields('28').value,'SEMAST','28','2245')<>'TRUE' then
         p_err_code := errnums.C_SA_TLTX_NOT_ALLOW_BY_ACCTNO;
         RETURN errnums.C_BIZ_RULE_INVALID;
     End if;


     l_SEMASTcheck_arr := txpks_check.fn_SEMASTcheck(p_txmsg.txfields('28').value,'SEMAST','ACCTNO');
...
BEGIN
   IF p_txmsg.deltd <> 'Y' THEN -- Normal transaction
      ...
      INSERT INTO SETRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
            VALUES (p_txmsg.txnum, TO_DATE (p_txmsg.txdate, systemnums.C_DATE_FORMAT),p_txmsg.txfields ('23').value,'0067',ROUND(p_txmsg.txfields('10').value*p_txmsg.txfields('11').value,0),NULL,p_txmsg.txfields ('06').value,p_txmsg.deltd,p_txmsg.txfields ('06').value,seq_SETRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'' || '' || '');

      INSERT INTO SETRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
            VALUES (p_txmsg.txnum, TO_DATE (p_txmsg.txdate, systemnums.C_DATE_FORMAT),p_txmsg.txfields ('23').value,'0068',ROUND(p_txmsg.txfields('10').value,0),NULL,p_txmsg.txfields ('06').value,p_txmsg.deltd,p_txmsg.txfields ('06').value,seq_SETRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'' || '' || '');

      INSERT INTO SETRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
            VALUES (p_txmsg.txnum, TO_DATE (p_txmsg.txdate, systemnums.C_DATE_FORMAT),p_txmsg.txfields ('28').value,'0051',ROUND(p_txmsg.txfields('10').value*p_txmsg.txfields('11').value,0),NULL,p_txmsg.txfields ('06').value,p_txmsg.deltd,p_txmsg.txfields ('06').value,seq_SETRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'' || '' || '');

      INSERT INTO SETRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
            VALUES (p_txmsg.txnum, TO_DATE (p_txmsg.txdate, systemnums.C_DATE_FORMAT),p_txmsg.txfields ('28').value,'0052',ROUND(p_txmsg.txfields('10').value,0),NULL,p_txmsg.txfields ('06').value,p_txmsg.deltd,p_txmsg.txfields ('06').value,seq_SETRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'' || '' || '');
      ...
      UPDATE SEMAST
         SET
           ...
           DCRAMT = DCRAMT + (ROUND(p_txmsg.txfields('10').value*p_txmsg.txfields('11').value,0)), LAST_CHANGE = SYSTIMESTAMP
        WHERE ACCTNO=p_txmsg.txfields('28').value;
