...
BEGIN
    ...
    ***************************************************************************************************/
    ...
    if p_txmsg.deltd <> 'Y' then
        ...
        p_txmsg.txfields('02').value,p_txmsg.txfields('68').value,
        p_txmsg.txfields('69').value,p_txmsg.txfields('90').value,
        p_txmsg.txfields('92').value,p_txmsg.txfields('10').value,0,'N', 'P',
        TO_DATE(p_txmsg.txfields('98').value,systemnums.c_date_format),p_txmsg.txfields('99').value,'0',
        '','');
    else
