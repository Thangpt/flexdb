CREATE OR REPLACE PACKAGE txpks_#8827ex
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#8827EX
...
CREATE OR REPLACE PACKAGE BODY txpks_#8827ex
IS
   pkgctx   plog.log_ctx;
