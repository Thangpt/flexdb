...
plog.setbeginsection (pkgctx, 'pr_txlog');
   ...
   plog.debug(pkgctx, 'abt to insert into tllogfld');
   INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
      VALUES( seq_tllogfld.NEXTVAL, p_txmsg.txnum, TO_DATE(p_txmsg.txdate, systemnums.C_DATE_FORMAT),'23',0,p_txmsg.txfields('23').value,'Paid adv type');
...
plog.setbeginsection (pkgctx, 'fn_txAppAutoCheck');
   IF p_txmsg.deltd = 'N' THEN
     ...
     --HaiLT them dk neu la gd batch thi ko can check trang thai tai khoan, de phong truong hop lam 0088 khi van con` tien ung truoc'
     IF NOT ( INSTR('A',l_STATUS) > 0) and (substr(p_txmsg.txnum,1,2) <> systemnums.C_BATCH_PREFIXED) THEN
        p_err_code := '-400100';
plog.setendsection (pkgctx, 'fn_txAppAutoCheck');
        RETURN errnums.C_BIZ_RULE_INVALID;
     END IF;
...
BEGIN
   IF p_txmsg.deltd <> 'Y' THEN -- Normal transaction
    ...
    IF to_char(p_txmsg.txfields('23').value) = 'B' THEN
        INSERT INTO CITRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
            VALUES (p_txmsg.txnum, TO_DATE (p_txmsg.txdate, systemnums.C_DATE_FORMAT),p_txmsg.txfields ('03').value,'0012',ROUND(p_txmsg.txfields('10').value+p_txmsg.txfields('11').value-p_txmsg.txfields('60').value*(p_txmsg.txfields('10').value+p_txmsg.txfields('11').value),0),NULL,p_txmsg.txfields ('03').value,p_txmsg.deltd,p_txmsg.txfields ('03').value,seq_CITRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'UTTB thanh to?ti?n mua ng?GD ' || p_txmsg.txfields ('42').VALUE || ', ng?TT ' || p_txmsg.txfields ('08').VALUE || '');
        INSERT INTO CITRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
            VALUES (p_txmsg.txnum, TO_DATE (p_txmsg.txdate, systemnums.C_DATE_FORMAT),p_txmsg.txfields ('03').value,'0054',ROUND(p_txmsg.txfields('60').value*(p_txmsg.txfields('10').value+p_txmsg.txfields('11').value),0),NULL,p_txmsg.txfields ('03').value,p_txmsg.deltd,p_txmsg.txfields ('03').value,seq_CITRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'UTTB thanh to?ti?n mua ng?GD ' || p_txmsg.txfields ('42').VALUE || ', ng?TT ' || p_txmsg.txfields ('08').VALUE || '');
        INSERT INTO CITRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
            VALUES (p_txmsg.txnum, TO_DATE (p_txmsg.txdate, systemnums.C_DATE_FORMAT),p_txmsg.txfields ('03').value,'0011',ROUND(p_txmsg.txfields('11').value-p_txmsg.txfields('60').value*p_txmsg.txfields('11').value,0),NULL,p_txmsg.txfields ('03').value,p_txmsg.deltd,p_txmsg.txfields ('03').value,seq_CITRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'Ph?TTB thanh to?ti?n mua ng?GD ' || p_txmsg.txfields ('42').VALUE || ', ng?TT ' || p_txmsg.txfields ('08').VALUE || '');
        INSERT INTO CITRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
            VALUES (p_txmsg.txnum, TO_DATE (p_txmsg.txdate, systemnums.C_DATE_FORMAT),p_txmsg.txfields ('03').value,'0053',ROUND(p_txmsg.txfields('60').value*p_txmsg.txfields('11').value,0),NULL,p_txmsg.txfields ('03').value,p_txmsg.deltd,p_txmsg.txfields ('03').value,seq_CITRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'Ph?TTB thanh to?ti?n mua ng?GD ' || p_txmsg.txfields ('42').VALUE || ', ng?TT ' || p_txmsg.txfields ('08').VALUE || '');
    else
        INSERT INTO CITRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
            VALUES (p_txmsg.txnum, TO_DATE (p_txmsg.txdate, systemnums.C_DATE_FORMAT),p_txmsg.txfields ('03').value,'0012',ROUND(p_txmsg.txfields('10').value+p_txmsg.txfields('11').value-p_txmsg.txfields('60').value*(p_txmsg.txfields('10').value+p_txmsg.txfields('11').value),0),NULL,p_txmsg.txfields ('03').value,p_txmsg.deltd,p_txmsg.txfields ('03').value,seq_CITRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'UTTB ng?GD ' || p_txmsg.txfields ('42').VALUE || ', ng?TT ' || p_txmsg.txfields ('08').VALUE || '');
        INSERT INTO CITRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
            VALUES (p_txmsg.txnum, TO_DATE (p_txmsg.txdate, systemnums.C_DATE_FORMAT),p_txmsg.txfields ('03').value,'0054',ROUND(p_txmsg.txfields('60').value*(p_txmsg.txfields('10').value+p_txmsg.txfields('11').value),0),NULL,p_txmsg.txfields ('03').value,p_txmsg.deltd,p_txmsg.txfields ('03').value,seq_CITRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'UTTB ng?GD ' || p_txmsg.txfields ('42').VALUE || ', ng?TT ' || p_txmsg.txfields ('08').VALUE || '');
        INSERT INTO CITRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
            VALUES (p_txmsg.txnum, TO_DATE (p_txmsg.txdate, systemnums.C_DATE_FORMAT),p_txmsg.txfields ('03').value,'0011',ROUND(p_txmsg.txfields('11').value-p_txmsg.txfields('60').value*p_txmsg.txfields('11').value,0),NULL,p_txmsg.txfields ('03').value,p_txmsg.deltd,p_txmsg.txfields ('03').value,seq_CITRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'Ph?TTB ng?GD ' || p_txmsg.txfields ('42').VALUE || ', ng?TT ' || p_txmsg.txfields ('08').VALUE || '');
        INSERT INTO CITRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
            VALUES (p_txmsg.txnum, TO_DATE (p_txmsg.txdate, systemnums.C_DATE_FORMAT),p_txmsg.txfields ('03').value,'0053',ROUND(p_txmsg.txfields('60').value*p_txmsg.txfields('11').value,0),NULL,p_txmsg.txfields ('03').value,p_txmsg.deltd,p_txmsg.txfields ('03').value,seq_CITRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'Ph?TTB ng?GD ' || p_txmsg.txfields ('42').VALUE || ', ng?TT ' || p_txmsg.txfields ('08').VALUE || '');
    end if;
      INSERT INTO CITRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
    ...
    IF to_char(p_txmsg.txfields('94').value) <> '0' THEN
      INSERT INTO CITRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
            VALUES (p_txmsg.txnum, TO_DATE (p_txmsg.txdate, systemnums.C_DATE_FORMAT),p_txmsg.txfields ('03').value,'0011',/*ROUND(p_txmsg.txfields('10').value,0)*/ 0,NULL,p_txmsg.txfields ('03').value,p_txmsg.deltd,p_txmsg.txfields ('03').value,seq_CITRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'' || '' || '');
    END IF;
