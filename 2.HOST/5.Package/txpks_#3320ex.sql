...
BEGIN
   ...
   select sum(blocked) into l_emkqtty from semast where codeid=l_codeid or codeid=l_wft_codeid;
    ...
    ***************************************************************************************************/
    ...
    exception
        when others then
          l_wft_codeid:=l_codeid;
    END;
      for rec in (select * from semast where codeid=l_codeid or codeid=l_wft_codeid)
      loop
