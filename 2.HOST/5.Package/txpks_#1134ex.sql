...
BEGIN
    ...
    ***************************************************************************************************/
    select count(1)
        into l_count
    from stschd
    where duetype = 'SM' and deltd <> 'Y' and trfbuyrate * trfbuyext * (amt-trfexeamt) > 0 and afacctno = p_txmsg.txfields(c_dacctno).value;
