...
plog.setbeginsection (pkgctx, 'pr_txlog');
   ...
   plog.debug(pkgctx, 'abt to insert into tllogfld');
   INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
      VALUES( seq_tllogfld.NEXTVAL, p_txmsg.txnum, TO_DATE(p_txmsg.txdate, systemnums.C_DATE_FORMAT),'52',0,NULL,'Min term');
   plog.debug(pkgctx, 'abt to insert into tllogfld');
   INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
      VALUES( seq_tllogfld.NEXTVAL, p_txmsg.txnum, TO_DATE(p_txmsg.txdate, systemnums.C_DATE_FORMAT),'51',0,NULL,'Others int paid');
   plog.debug(pkgctx, 'abt to insert into tllogfld');
   INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
   ...
   INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
      VALUES( seq_tllogfld.NEXTVAL, p_txmsg.txnum, TO_DATE(p_txmsg.txdate, systemnums.C_DATE_FORMAT),'90',TO_NUMBER(p_txmsg.txfields('90').value),NULL,'Paid for int. normal');
         ...
         plog.debug(pkgctx, 'abt to insert into tllogfld');
   INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
      VALUES( seq_tllogfld.NEXTVAL, p_txmsg.txnum, TO_DATE(p_txmsg.txdate, systemnums.C_DATE_FORMAT),'86',TO_NUMBER(p_txmsg.txfields('86').value),NULL,'pay bank');
...
BEGIN
   IF p_txmsg.deltd <> 'Y' THEN -- Normal transaction
      ...
      INSERT INTO CITRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
            VALUES (p_txmsg.txnum, TO_DATE (p_txmsg.txdate, systemnums.C_DATE_FORMAT),p_txmsg.txfields ('05').value,'0062',ROUND(p_txmsg.txfields('60').value+p_txmsg.txfields('61').value+p_txmsg.txfields('62').value+p_txmsg.txfields('63').value+p_txmsg.txfields('70').value+p_txmsg.txfields('71').value+p_txmsg.txfields('72').value+p_txmsg.txfields('73').value+p_txmsg.txfields('74').value+p_txmsg.txfields('76').value+p_txmsg.txfields('79').value+p_txmsg.txfields('84').value+p_txmsg.txfields('92').value,0),NULL,p_txmsg.txfields ('03').value,p_txmsg.deltd,p_txmsg.txfields ('03').value,seq_CITRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'' || '' || '');

      INSERT INTO CITRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
            VALUES (p_txmsg.txnum, TO_DATE (p_txmsg.txdate, systemnums.C_DATE_FORMAT),p_txmsg.txfields ('05').value,'0064',ROUND(p_txmsg.txfields('61').value+p_txmsg.txfields('64').value+p_txmsg.txfields('75').value+p_txmsg.txfields('77').value+p_txmsg.txfields('97').value,0),NULL,p_txmsg.txfields ('03').value,p_txmsg.deltd,p_txmsg.txfields ('03').value,seq_CITRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'' || '' || '');
      ...
      INSERT INTO LNTRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
            VALUES (p_txmsg.txnum, TO_DATE (p_txmsg.txdate, systemnums.C_DATE_FORMAT),p_txmsg.txfields ('03').value,'0019',ROUND(p_txmsg.txfields('86').value,0),NULL,p_txmsg.txfields ('01').value,p_txmsg.deltd,p_txmsg.txfields ('01').value,seq_LNTRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'' || '' || '');
      ...
      UPDATE LNMAST
         SET
           ...
           INTNMLACRBANK = INTNMLACRBANK - (ROUND(p_txmsg.txfields('86').value,0)),
      ...
      UPDATE CIMAST
         SET
           ...
           DUEAMT = DUEAMT - (ROUND(p_txmsg.txfields('64').value+p_txmsg.txfields('75').value+p_txmsg.txfields('77').value+p_txmsg.txfields('97').value,0)),
           OVAMT = OVAMT - (ROUND(p_txmsg.txfields('60').value+p_txmsg.txfields('61').value+p_txmsg.txfields('62').value+p_txmsg.txfields('63').value+p_txmsg.txfields('70').value+p_txmsg.txfields('71').value+p_txmsg.txfields('72').value+p_txmsg.txfields('73').value+p_txmsg.txfields('74').value+p_txmsg.txfields('76').value+p_txmsg.txfields('79').value+p_txmsg.txfields('84').value+p_txmsg.txfields('92').value,0)), LAST_CHANGE = SYSTIMESTAMP
        WHERE ACCTNO=p_txmsg.txfields('05').value;
...
UPDATE TLLOG
 SET DELTD = 'Y'
      ...
      SET
           ...
           PRINPAID=PRINPAID - (ROUND(p_txmsg.txfields('63').value+p_txmsg.txfields('64').value+p_txmsg.txfields('65').value,0)),
           FEE=FEE + (ROUND(p_txmsg.txfields('78').value,0)),
           OINTPAID=OINTPAID - (ROUND(p_txmsg.txfields('71').value+p_txmsg.txfields('73').value+p_txmsg.txfields('76').value+p_txmsg.txfields('79').value,0)),
           INTNMLACRBANK = INTNMLACRBANK + (ROUND(p_txmsg.txfields('86').value,0))
