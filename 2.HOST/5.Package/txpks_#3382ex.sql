-- Start of DDL Script for Package HOST.TXPKS_#3382EX
-- Generated 19-Feb-2021 17:51:00 from HOST@FLEXREPORT
    ...
    ***************************************************************************************************/
    ...
    if p_txmsg.deltd <> 'Y' then
       /* if l_transfertimes = 1 then
        ...
        from caschd where camastid = p_txmsg.txfields(c_camastid).value and afacctno = p_txmsg.txfields(c_afacct2).value and  deltd <> 'Y'
        AND isreceive='N';
        if l_count > 0 THEN
...
-- End of DDL Script for Package HOST.TXPKS_#3382EX
