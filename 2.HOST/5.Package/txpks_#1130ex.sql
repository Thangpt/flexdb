...
BEGIN
    ...
    ***************************************************************************************************/
    ...
    SELECT custid INTO l_custid1 FROM afmast WHERE acctno=  p_txmsg.txfields(c_dracctno).value;
    SELECT custid INTO l_custid2 FROM afmast WHERE acctno=  p_txmsg.txfields(c_cracctno).value;
...
BEGIN
    ...
    ***************************************************************************************************/
    --1.5.3.0
    IF p_txmsg.txfields('95').value IS NOT NULL THEN
      pr_insertiplog( p_txmsg.txnum,  p_txmsg.txdate, p_txmsg.ipaddress, 'T', '0', 'MAC', p_txmsg.txfields('95').value, p_err_code);
    END IF;
