...
BEGIN
   ...
   IF p_txmsg.deltd <> 'Y' THEN
    plog.error (pkgctx, 'TEST11 '|| TO_DATE(p_txmsg.txfields('06').value, systemnums.C_DATE_FORMAT) );
    plog.error (pkgctx, 'TEST12 '|| TO_DATE(p_txmsg.txfields('12').value, systemnums.C_DATE_FORMAT));
    plog.error (pkgctx, 'TEST14 '|| p_txmsg.txfields('03').value );
   UPDATE CAMAST
      SET
