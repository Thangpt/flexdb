...
plog.setbeginsection (pkgctx, 'pr_txlog');
   ...
   /*plog.debug(pkgctx, 'abt to insert into tllogfld 01');
   ...
   plog.debug(pkgctx, 'abt to insert into tllogfld 60');
   INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
   ...
   plog.debug(pkgctx, 'abt to insert into tllogfld 02');
   INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
   ...
   plog.debug(pkgctx, 'abt to insert into tllogfld 06');
   INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
   ...
   plog.debug(pkgctx, 'abt to insert into tllogfld 50');
   INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
   ...
   plog.debug(pkgctx, 'abt to insert into tllogfld 21');
   INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
   ...
   plog.debug(pkgctx, 'abt to insert into tllogfld 22');
   INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
   ...
   plog.debug(pkgctx, 'abt to insert into tllogfld 34');
   INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
   ...
   plog.debug(pkgctx, 'abt to insert into tllogfld 23');
   INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
   ...
   plog.debug(pkgctx, 'abt to insert into tllogfld 24');
   INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
   ...
   plog.debug(pkgctx, 'abt to insert into tllogfld 25');
   INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
   ...
   plog.debug(pkgctx, 'abt to insert into tllogfld 72');
   INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
   ...
   plog.debug(pkgctx, 'abt to insert into tllogfld 26');
   INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
   ...
   plog.debug(pkgctx, 'abt to insert into tllogfld 27');
   INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
   ...
   plog.debug(pkgctx, 'abt to insert into tllogfld 28');
   INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
   ...
   plog.debug(pkgctx, 'abt to insert into tllogfld 29');
   INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
   ...
   plog.debug(pkgctx, 'abt to insert into tllogfld 04');
   INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
   ...
   plog.debug(pkgctx, 'abt to insert into tllogfld 94');
   INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
   ...
   plog.debug(pkgctx, 'abt to insert into tllogfld 32');
   INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
   ...
   plog.debug(pkgctx, 'abt to insert into tllogfld 35');
   INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
      VALUES( seq_tllogfld.NEXTVAL, p_txmsg.txnum, TO_DATE(p_txmsg.txdate, systemnums.C_DATE_FORMAT),'35',0,'','AdvIdRef');
   plog.debug(pkgctx, 'abt to insert into tllogfld 73');
   INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
   ...
   plog.debug(pkgctx, 'abt to insert into tllogfld 33');
   INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
   ...
   plog.debug(pkgctx, 'abt to insert into tllogfld 71');
   INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
   ...
   plog.debug(pkgctx, 'abt to insert into tllogfld 31');
   INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
...
plog.setbeginsection (pkgctx, 'fn_txAppAutoCheck');
   IF p_txmsg.deltd = 'N' THEN
    ...
    plog.debug(pkgctx,' begin txpks_check.fn_aftxmapcheck: ');
    ...
    plog.debug(pkgctx,' end txpks_check.fn_SEMASTcheck: ' || p_txmsg.txfields('28').value || ' l_MORTAGE: ' || l_MORTAGE || ' l_dblGRPCount: ' || l_dblGRPCount);
     ...
     IF NOT ( INSTR('A',l_STATUS) > 0) THEN
        ...
        RETURN errnums.C_BIZ_RULE_INVALID;
     END IF;
     plog.debug(pkgctx,' end fn_txAppAutoCheck: ');
    END IF;
   plog.setendsection (pkgctx, 'fn_txAppAutoCheck');
...
EXCEPTION
  WHEN others THEN
      ...
      plog.error (pkgctx, SQLERRM);
       plog.setendsection (pkgctx, 'fn_txAppAutoCheck');
       plog.debug(pkgctx,'fn_txAppAutoCheck: ' || dbms_utility.format_error_backtrace);
      RAISE errnums.E_SYSTEM_ERROR;
...
-- Run Auto check
   IF fn_txAppAutoCheck(p_txmsg,p_err_code) <> systemnums.C_SUCCESS THEN
       ...
       RETURN errnums.C_BIZ_RULE_INVALID;
   END IF;
    plog.debug(pkgctx,'txpks_#8877EX.fn_txAftAppCheck');
-- Run After check
