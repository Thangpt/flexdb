 ...
 */   l_dbl_left_rightoffrate := nvl(to_number(substr(l_rightoffrate,0,instr(l_rightoffrate,'/') - 1)),1);
    ...
    if(l_isci='N' AND l_status='S') THEN
         UPDATE cimast SET receiving =receiving- (l_old_amt-l_amt)
        ...
        VALUES (p_txmsg.txnum, TO_DATE (p_txmsg.txdate, systemnums.C_DATE_FORMAT),l_afacctno,'0045',(l_old_amt-l_amt),NULL,l_autoid,p_txmsg.deltd,l_autoid,seq_CITRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'' || '' || '');
