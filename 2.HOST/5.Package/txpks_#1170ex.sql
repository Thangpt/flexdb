CREATE OR REPLACE PACKAGE TXPKS_#1170EX
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#1170EX
...
END;
/
CREATE OR REPLACE PACKAGE BODY TXPKS_#1170EX
IS
   pkgctx   plog.log_ctx;
    ...
    ***************************************************************************************************/
    ...
    IF p_txmsg.deltd <> 'Y' THEN
      ...
      IF l_isCoreBank = 'Y' THEN
        ...
        VALUES (p_txmsg.txnum, p_txmsg.txdate, p_txmsg.txfields ('03').value, '0051', ROUND(p_txmsg.txfields('10').value,0),NULL,'',p_txmsg.deltd,'',seq_CITRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'' || '' || '');
        UPDATE cimast SET holdbalance = holdbalance - p_txmsg.txfields('10').value
