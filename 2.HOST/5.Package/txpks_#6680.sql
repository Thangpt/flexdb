...
IS
    ...
    BEGIN
        ...
        -- Run Pre Update
        IF TXPKS_#6680EX.FN_TXPREAPPUPDATE (P_TXMSG, P_ERR_CODE) <>
        ...
        -- Run After Update
        IF TXPKS_#6680EX.FN_TXAFTAPPUPDATE (P_TXMSG, P_ERR_CODE) <>
               SYSTEMNUMS.C_SUCCESS
        THEN
            RETURN ERRNUMS.C_BIZ_RULE_INVALID;
        END IF;
    ...
    BEGIN
        ...
        -- Run Pre check
        IF TXPKS_#6680EX.FN_TXPREAPPCHECK (P_TXMSG, P_ERR_CODE) <>
               SYSTEMNUMS.C_SUCCESS
        THEN
            RETURN ERRNUMS.C_BIZ_RULE_INVALID;
        END IF;
        ...
        -- Run After check
        IF TXPKS_#6680EX.FN_TXAFTAPPCHECK (P_TXMSG, P_ERR_CODE) <>
               SYSTEMNUMS.C_SUCCESS
        THEN
            RETURN ERRNUMS.C_BIZ_RULE_INVALID;
        END IF;
    ...
    BEGIN
        ...
        LOOP
            ...
            IF TXPKS_#6680.FN_AUTOTXPROCESS (L_TXMSG,
                   ...
                   SYSTEMNUMS.C_SUCCESS
            THEN
                PLOG.DEBUG (PKGCTX, 'got error 6680: ' || P_ERR_CODE);
                ROLLBACK;
                RETURN ERRNUMS.C_SYSTEM_ERROR;
            END IF;
