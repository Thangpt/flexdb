...
*/
    ...
    IF p_txmsg.deltd <> 'Y' THEN
       ...
       IF v_count = 0 THEN
          ...
          VALUES (
               ...
               p_txmsg.txfields('15').VALUE, p_txmsg.txfields('09').VALUE, p_txmsg.txfields('17').VALUE, p_txmsg.txdesc );
       ELSE
    ...
    ELSE --IF p_txmsg.deltd <> 'Y' THEN
       UPDATE POMAST SET DELTD ='Y' WHERE TXDATE=to_date(p_txmsg.txfields('98').VALUE, systemnums.C_DATE_FORMAT) AND TXNUM=p_txmsg.txfields('99').VALUE;
