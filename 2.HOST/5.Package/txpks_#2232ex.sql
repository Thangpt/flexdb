...
insert into semastdtl (AUTOID, ACCTNO, QTTY, QTTYTYPE, TXNUM, TXDATE, DELTD, DFQTTY, STATUS)
values (seq_semastdtl.NEXTVAL,v_strACCTNO, v_nAMT, '011', v_txnum, v_txdate, 'N', 0, 'N');
ELSE
