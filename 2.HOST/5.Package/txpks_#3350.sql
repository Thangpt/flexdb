...
BEGIN
   IF p_txmsg.deltd <> 'Y' THEN -- Normal transaction
      ...
      INSERT INTO CITRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
            VALUES (p_txmsg.txnum, TO_DATE (p_txmsg.txdate, systemnums.C_DATE_FORMAT),p_txmsg.txfields ('03').value,'0011',ROUND(p_txmsg.txfields('20').value*p_txmsg.txfields('60').value,0),NULL,p_txmsg.txfields ('01').value,p_txmsg.deltd,p_txmsg.txfields ('01').value,seq_CITRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'' || l_txdesc || '');

      l_txdesc:= cspks_system.fn_DBgen_trandesc_with_format(p_txmsg,'3350','CI','0012','0002');
      INSERT INTO CITRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
            VALUES (p_txmsg.txnum, TO_DATE (p_txmsg.txdate, systemnums.C_DATE_FORMAT),p_txmsg.txfields ('03').value,'0012',ROUND(p_txmsg.txfields('13').value*p_txmsg.txfields('60').value,0),NULL,p_txmsg.txfields ('01').value,p_txmsg.deltd,p_txmsg.txfields ('01').value,seq_CITRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'' || l_txdesc || '');

      l_txdesc:= cspks_system.fn_DBgen_trandesc_with_format(p_txmsg,'3350','CI','0012','0001');
      INSERT INTO CITRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
            VALUES (p_txmsg.txnum, TO_DATE (p_txmsg.txdate, systemnums.C_DATE_FORMAT),p_txmsg.txfields ('03').value,'0012',ROUND((p_txmsg.txfields('10').value-p_txmsg.txfields('13').value)*p_txmsg.txfields('60').value,0),NULL,p_txmsg.txfields ('01').value,p_txmsg.deltd,p_txmsg.txfields ('01').value,seq_CITRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'' || l_txdesc || '');
...
---
    ...
    IF to_char(p_txmsg.txfields('61').value) <> '0' THEN
      INSERT INTO SETRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
            VALUES (p_txmsg.txnum, TO_DATE (p_txmsg.txdate, systemnums.C_DATE_FORMAT),p_txmsg.txfields ('08').value,'0067',ROUND(p_txmsg.txfields('10').value-p_txmsg.txfields('20').value,0),NULL,p_txmsg.txfields ('01').value,p_txmsg.deltd,p_txmsg.txfields ('01').value,seq_SETRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'' || '' || '');
    END IF;

    IF to_char(p_txmsg.txfields('61').value) <> '0' THEN
      INSERT INTO SETRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
            VALUES (p_txmsg.txnum, TO_DATE (p_txmsg.txdate, systemnums.C_DATE_FORMAT),p_txmsg.txfields ('08').value,'0011',ROUND(p_txmsg.txfields('11').value,0),NULL,p_txmsg.txfields ('02').value,p_txmsg.deltd,p_txmsg.txfields ('02').value,seq_SETRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'' || '' || '');
    END IF;


      UPDATE CIMAST
         SET
           BALANCE = BALANCE + (ROUND((p_txmsg.txfields('10').value-p_txmsg.txfields('13').value)*p_txmsg.txfields('60').value,0)) + (ROUND(p_txmsg.txfields('13').value*p_txmsg.txfields('60').value,0)) - (ROUND(p_txmsg.txfields('20').value*p_txmsg.txfields('60').value,0)),
    ...
    IF to_char(p_txmsg.txfields('61').value) <> '0' THEN
      ...
      UPDATE SEMAST
         SET
           ...
           DDROUTAMT = DDROUTAMT + (ROUND(p_txmsg.txfields('10').value-p_txmsg.txfields('20').value,0)), LAST_CHANGE = SYSTIMESTAMP
