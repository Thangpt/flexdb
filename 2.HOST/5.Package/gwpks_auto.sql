       ...
       LOOP
          ...
          --kiem tra Custody Code hoac Sub-Account co ton tai khong
            ...
            ELSE
                ...
                SELECT count(1) INTO v_count FROM AFMAST AF, CFMAST CF WHERE CF.CUSTID=AF.CUSTID AND AF.STATUS <> 'C' AND AF.TRADEONLINE='Y' AND CF.CUSTODYCD=rec.REFACCTNO;
                if v_count > 1 then
                ...
                SELECT AF.ACCTNO INTO v_subaccount FROM AFMAST AF, CFMAST CF WHERE CF.CUSTID=AF.CUSTID AND AF.STATUS <> 'C' AND AF.TRADEONLINE='Y' AND CF.CUSTODYCD=rec.REFACCTNO;
        ...
        LOOP
            ...
            BEGIN
                ...
                IF rec.ISSUBACCT='N' THEN
                    BEGIN
                        SELECT AF.ACCTNO INTO v_newafacctno FROM AFMAST AF, CFMAST CF WHERE CF.CUSTID=AF.CUSTID AND AF.STATUS <> 'C' AND AF.TRADEONLINE='Y' AND CF.CUSTODYCD=rec.REFACCTNO;
                    EXCEPTION
                    WHEN OTHERS THEN
