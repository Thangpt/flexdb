-- Start of DDL Script for Package HOSTMSTRADE.TXPKS_#3325EX
-- Generated 11/04/2017 1:42:59 PM from HOSTMSTRADE@FLEX_111
            ...
            -- Tinh gia tri chung khoan cho quyen ve.
             ...
             ELSIF l_catype = '021' THEN --gc_CA_CATYPE_KIND_STOCK
              ...
              ELSIF l_catype = '020' THEN --gc_CA_CATYPE_CONVERT_STOCK
                ...
                plog.debug (pkgctx,'3325EX: ' || l_sql );
            ...
            IF l_catype = '014' THEN
                    ...
                    loop
                           ...
                           if p_err_code <> systemnums.c_success then
                                plog.error('pr_RightoffRegiter2BO_for_imp return ERROR!:'||p_err_code);
...
-- End of DDL Script for Package HOSTMSTRADE.TXPKS_#3325EX
