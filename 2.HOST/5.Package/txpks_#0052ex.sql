CREATE OR REPLACE PACKAGE TXPKS_#0052EX
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#0052EX
...
END;
/
CREATE OR REPLACE PACKAGE BODY TXPKS_#0052EX
IS
   pkgctx   plog.log_ctx;
...
BEGIN
    ...
    ***************************************************************************************************/
    ...
    LOOP
        ...
        IF REGEXP_LIKE(rec.traderid, specialPartern) THEN
        ...
        IF l_count > 0 THEN
            p_err_code := '-200408'; -- Invalid status
            plog.setendsection (pkgctx, 'fn_txPreAppCheck');
            RETURN errnums.C_BIZ_RULE_INVALID;
        END IF;
    END LOOP;
...
BEGIN
    ...
    ***************************************************************************************************/
    ...
    LOOP
        ...
        VALUES (seq_bl_traderef.nextval,p_txmsg.txfields (c_blacctno).value,p_txmsg.txfields (c_acctno).value,rec.traderid, getcurrdate,'A');
    END LOOP;
