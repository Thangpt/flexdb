...
BEGIN
   IF p_txmsg.deltd <> 'Y' THEN -- Normal transaction
      ...
      INSERT INTO TDTRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
            VALUES (p_txmsg.txnum, TO_DATE (p_txmsg.txdate, systemnums.C_DATE_FORMAT),p_txmsg.txfields ('03').value,'0023',ROUND(p_txmsg.txfields('10').value*p_txmsg.txfields('16').value,0),NULL,'',p_txmsg.deltd,'',seq_TDTRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'Rút g?c ti?t ki?m, g?i ngày ' || p_txmsg.txfields ('18').VALUE || ', s? ti?n g?i ban d?u ' || p_txmsg.txfields ('17').VALUE || '');

      INSERT INTO TDTRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
            VALUES (p_txmsg.txnum, TO_DATE (p_txmsg.txdate, systemnums.C_DATE_FORMAT),p_txmsg.txfields ('03').value,'0024',ROUND(p_txmsg.txfields('10').value*p_txmsg.txfields('16').value,0),NULL,'',p_txmsg.deltd,'',seq_TDTRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'Rút g?c ti?t ki?m, g?i ngày ' || p_txmsg.txfields ('18').VALUE || ', s? ti?n g?i ban d?u ' || p_txmsg.txfields ('17').VALUE || '');

      INSERT INTO TDTRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
            VALUES (p_txmsg.txnum, TO_DATE (p_txmsg.txdate, systemnums.C_DATE_FORMAT),p_txmsg.txfields ('03').value,'0026',ROUND(p_txmsg.txfields('11').value,0),NULL,'',p_txmsg.deltd,'',seq_TDTRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'Nh?n lãi ti?t ki?m, g?i ngày ' || p_txmsg.txfields ('18').VALUE || ', s? ti?n g?i ban d?u ' || p_txmsg.txfields ('17').VALUE || '');
      ...
      INSERT INTO CITRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
            VALUES (p_txmsg.txnum, TO_DATE (p_txmsg.txdate, systemnums.C_DATE_FORMAT),p_txmsg.txfields ('05').value,'0029',ROUND(p_txmsg.txfields('10').value*p_txmsg.txfields('16').value,0),NULL,p_txmsg.txfields ('03').value,p_txmsg.deltd,p_txmsg.txfields ('03').value,seq_CITRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'Rút g?c ti?t ki?m, g?i ngày ' || p_txmsg.txfields ('18').VALUE || ', s? ti?n g?i ban d?u ' || p_txmsg.txfields ('17').VALUE || '');

      INSERT INTO CITRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
            VALUES (p_txmsg.txnum, TO_DATE (p_txmsg.txdate, systemnums.C_DATE_FORMAT),p_txmsg.txfields ('05').value,'0012',ROUND(p_txmsg.txfields('11').value*p_txmsg.txfields('20').value,0),NULL,p_txmsg.txfields ('03').value,p_txmsg.deltd,p_txmsg.txfields ('03').value,seq_CITRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'Nh?n lãi ti?t ki?m, g?i ngày ' || p_txmsg.txfields ('18').VALUE || ', s? ti?n g?i ban d?u ' || p_txmsg.txfields ('17').VALUE || '');



      UPDATE CIMAST
         SET
           BALANCE = BALANCE + (ROUND(p_txmsg.txfields('10').value*p_txmsg.txfields('16').value,0)) + (ROUND(p_txmsg.txfields('11').value*p_txmsg.txfields('20').value,0)), LAST_CHANGE = SYSTIMESTAMP
        WHERE ACCTNO=p_txmsg.txfields('05').value;


      UPDATE TDMAST
         SET
           BALANCE = BALANCE - (ROUND(p_txmsg.txfields('10').value*p_txmsg.txfields('16').value,0)),
           INTPAID = INTPAID + (ROUND(p_txmsg.txfields('11').value,0)),
           PRINTPAID = PRINTPAID + (ROUND(p_txmsg.txfields('10').value*p_txmsg.txfields('16').value,0)),
