-- Start of DDL Script for Package HOSTMSTRADE.TX
-- Generated 22/10/2018 2:19:46 PM from HOSTMSTRADE@FLEX_111
...
TYPE msg_3 is RECORD (
    ...
    UserRequestID          VARCHAR2(200)    --MSBS-1853     HNX_update_GL
    );
...
TYPE msg_B is RECORD (
    ...
    LinesOfText             VARCHAR2(100),
    Text              VARCHAR2(4000) --Edit 20151008
    );
--MSBS-1853     HNX_update_GL  msg doi mat khau GW
...
--End MSBS-1853     HNX_update_GL
END;
/



-- End of DDL Script for Package HOSTMSTRADE.TX
