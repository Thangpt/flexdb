CREATE OR REPLACE PACKAGE txpks_#2656ex
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#2656EX
...
CREATE OR REPLACE PACKAGE BODY txpks_#2656ex
IS
   pkgctx   plog.log_ctx;
   ...
   c_ttrate           CONSTANT CHAR(2) := '10';
   c_amtrtt           CONSTANT CHAR(2) := '42';
...
BEGIN
    ...
    ***************************************************************************************************/
     ...
     IF NOT (to_number(l_DFBLOCKAMT) >= to_number(p_txmsg.txfields('41').value)) THEN
        p_err_code := '-400039';
