CREATE OR REPLACE FORCE VIEW VW_VSDTXREQ AS
...
FROm VSDTXREQ REQ, ALLCODE A5,tlprofiles tl,allcode a6,
...
to_char(NVL(log.Timecreated, LOG2.TIMECREATED),'hh24:mi:ss') CREATEDATE2, to_date(to_char(NVL(log.Timecreated, LOG2.TIMECREATED),'DD/MM/RRRR'),'DD/MM/RRRR') TXDATE2,
(CASE WHEN DTL4.FLDVAL = 'NORM' THEN DTL3.FLDVAL ELSE DTL3.FLDVAL||'_WFT' END) SYMBOL, TO_NUMBER(REPLACE(DTL1.FLDVAL,',','')) QTTY,
