CREATE OR REPLACE VIEW VW_SE9992CW AS
...
(
    ...
    TO_NUMBER(SUBSTR(SB.EXERCISERATIO,INSTR(SB.EXERCISERATIO,'/')+1,LENGTH(SB.EXERCISERATIO)))*/ SB.EXERCISERATIO CHANGERATIO, SB.COVEREDWARRANTTYPE, SB.EXERCISEPRICE, SB.MATURITYDATE, SB.LASTTRADINGDATE, SB.SETTLEMENTTYPE, S.BASICPRICE SETTLEMENTPRICE,
    SE.TRADE+SE.MORTAGE+SE.MARGIN+SE.SECURED+SE.BLOCKED+SE.WITHDRAW + NVL(RCV.STSRECEIVINGAMT,0) - NVL(STS.EXECQTTY,0) PREVQTTY
    FROM VW_SEMAST_CUSTODYCD SE, SBSECURITIES SB, SECURITIES_INFO S,
    (
