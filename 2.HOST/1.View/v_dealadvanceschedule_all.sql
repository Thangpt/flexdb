CREATE OR REPLACE FORCE VIEW V_DEALADVANCESCHEDULE_ALL AS
(
SELECT MST.AFACCTNO,MST.AMT,MST.FULLNAME,MST.CUSTODYCD,
                ...
                GREATEST (ROUND(ADVAMT*MST.DAYS*FEECMP/100/360),MST.MINBAL)* avatrate /100 +
                GREATEST (ROUND(ADVAMT*MST.DAYS*FEEBANK/100/360),MST.MINFEEBANK) * avatrate /100 VATAMT, /*10/100 VATAMT,*/
