CREATE OR REPLACE FORCE VIEW VW_MR1002 AS
...
CALLDATE, CALLTIME, SEC.clamt,SEC.odamt, AF.CAREBY
,nvl(ln.NYOVDAMT,0) NYOVDAMT
, nvl(ln.MPOVDAMT,0) MPOVDAMT
,af.brid,fn_get_emailmg(af.acctno,'NAME') REFULLNAME,fn_get_emailmg(af.acctno,'EMAIL') EMAILIBR,fn_get_emailmg(af.acctno,'EMAILPCC') EMAILPCC,fn_get_emailmg(af.acctno,'EMAILCN') EMAILBRID,fn_get_emailmg(af.acctno,'EMAILNV')  EMAILNGHIEPVU,
tl.grpname
