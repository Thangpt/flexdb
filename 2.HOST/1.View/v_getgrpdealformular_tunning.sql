CREATE OR REPLACE FORCE VIEW V_GETGRPDEALFORMULAR_TUNNING AS
(
                    ...
                    SELECT C.GROUPID, A.AFACCTNO,A.AMT,A.QTTY,b.qtty execqtty,A.FAMT,A.AAMT,A.ORGORDERID,A.PAIDAMT,
                            ...
                            FROM (
                                SELECT  1 ISMORTAGE,STSCHD.AFACCTNO,AMT,QTTY,FAMT,
                                        ...
                                        STSCHD.TXDATE,
                                       STSCHD.CLEARDATE,
                                       (CASE WHEN AFT.VAT='Y' THEN STSCHD.SECDUTY ELSE 0 END) SECDUTY ,
                                       ODTYPE.DEFFEERATE,
                                ...
                                (SELECT STS.ORGORDERID,STS.TXDATE,STS.AFACCTNO, STS.CODEID CODEID,
                                 ...
                                 AFMAST AFM, AFTYPE AFT, ADTYPE ADT
                                WHERE AMT>0
