create or replace force view v_mo_am_tien_ck_bk as
select sebal.custodycd,
    ...
    as Giao_Dich,       -- So luong giao dich tuong ung voi VSD
...
(
    select se.afacctno, sb.symbol, se.acctno seacctno,
        sum(case when fld.tltxcd = '2202' then nvalue else 0 end) cr_block_amt,
        sum(case when fld.tltxcd = '2203' then nvalue else 0 end) dr_block_amt
