create or replace force view vw_citran_gen as
...
union all
select "AUTOID","CUSTODYCD","CUSTID","TXNUM","TXDATE","ACCTNO","TXCD","NAMT","CAMT","REF","DELTD","ACCTREF","TLTXCD","BUSDATE","TXDESC","TXTIME","BRID","TLID","OFFID","CHID","DFACCTNO","OLD_DFACCTNO","TXTYPE","FIELD", "TLLOG_AUTOID", "TRDESC","OFFTIME"
from citran_gen
where deltd <> 'Y';
