CREATE OR REPLACE FORCE VIEW V_CFMAST AS
...
A17.CDCONTENT INCOMERANGE,A18.CDCONTENT ASSETRANGE,BRID,CAREBY,APPROVEID,LASTDATE,AUDITORID,AUDITDATE,MARGINLIMIT,TRADELIMIT,

ADVANCELIMIT,REPOLIMIT,DEPOSITLIMIT,MORTAGERATE,A19.CDCONTENT LANGUAGE,BANKACCTNO,A20.CDCONTENT BANKCODE,A21.CDCONTENT MARRIED,DESCRIPTION,A22.CDCONTENT STATUS
FROM
