CREATE OR REPLACE FORCE VIEW VW_STRADE_CA_RIGHTOFF AS
(
SELECT (RECEIVING + getbaldefovd(CI.AFACCTNO))ABC, ca.autoid  ,CF.CUSTODYCD, CF.FULLNAME,AF.TRADEPHONE PHONE, CA.AFACCTNO,
...
,greatest(getbaldefovd(CI.AFACCTNO),getbaldeftrfamtex(CI.AFACCTNO)) BALDEFOVD
--Chaunh 23/04/2012: lay corebank, ty le thuc hien
,AF.BANKACCTNO, AF.BANKNAME, sym_org.symbol SYMBOL_ORG
,CAMAST.exrate, CA.AFACCTNO||(NVL(CAMAST.TOCODEID,CAMAST.CODEID))  ACCTNO_UPDATECOST
