...
(orderid, tradeplace, afacctno, custodycd, actype, codeid, seacctno, ciacctno, txnum, txdate, txtime, expdate, bratio, timetype, exectype, nork, matchtype, via, clearday, clearcd, orstatus, pricetype, edstatus, quoteprice, stopprice, limitprice, orderqtty, remainqtty, execqtty, standqtty, cancelqtty, adjustqtty, rejectqtty, rejectcd, custid, exprice, exqtty, deltd, oodstatus, outpriceallow, puttype, contraorderid, contrafrm, litmitprice, quoteqtty, confirmed)
AS
(
...
'N' OODSTATUS,OUTPRICEALLOW,'O' puttype,'' contraorderid,'' contrafrm, FO.LIMITPRICE, FO.QUOTEQTTY, FO.CONFIRMED
...
ODMAST.EXPDATE, BRATIO, A1.CDCONTENT TIMETYPE, A2.CDCONTENT EXECTYPE, A3.CDCONTENT NORK, A4.CDCONTENT MATCHTYPE,
...
OOD.OODSTATUS,'Y' OUTPRICEALLOW,ODMAST.puttype,ODMAST.contraorderid,ODMAST.contrafrm, ODMAST.LIMITPRICE, ODMAST.QUOTEQTTY, ODMAST.CONFIRMED
