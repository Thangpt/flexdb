-- Start of DDL Script for View HOSTMSTRADE.VW_ODMAST_EXC_FEETERM
-- Generated 11/04/2017 3:46:05 PM from HOSTMSTRADE@FLEX_111

CREATE OR REPLACE VIEW vw_odmast_exc_feeterm (
   orderid,
   autoid,
   forp,
   feeamt,
...
-- End of DDL Script for View HOSTMSTRADE.VW_ODMAST_EXC_FEETERM
