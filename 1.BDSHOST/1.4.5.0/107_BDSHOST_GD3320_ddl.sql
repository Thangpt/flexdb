DELETE FROM tltx WHERE tltxcd = '3320';
...
DELETE FROM fldmaster WHERE objname = '3320';
...
DELETE FROM fldval WHERE objname = '3320';
...
DELETE FROM deferror WHERE errnum IN ('-900089','-900090');
