...
INSERT INTO DEFERROR (ERRNUM,ERRDESC,EN_ERRDESC,MODCODE,CONFLVL)
VALUES (-95026,'[-95026] - Mã CK b? ng?ng giao d?ch/h?y niêm y?t/ki?m soát/c?nh báo…','[-95026]:  Ticker stopped trading / Delisting / control / warning','NFO',null);
INSERT INTO DEFERROR (ERRNUM,ERRDESC,EN_ERRDESC,MODCODE,CONFLVL)
...
INSERT INTO DEFERROR (ERRNUM,ERRDESC,EN_ERRDESC,MODCODE,CONFLVL)
VALUES (-95043,'[-95043] - Ðóng c?a th? tru?ng','[-95043] - Closing the market','NFO',null);
INSERT INTO DEFERROR (ERRNUM,ERRDESC,EN_ERRDESC,MODCODE,CONFLVL)
VALUES (-95046,'[-95046] - Vượt quá số lượng lệnh trùng nhau cho phép','[-95046] - Vượt quá số lượng lệnh trùng nhau cho phép','NFO',null);
INSERT INTO DEFERROR (ERRNUM,ERRDESC,EN_ERRDESC,MODCODE,CONFLVL)
VALUES (-95047,'[-95047] - Trạng thái lệnh không hợp lệ, không thể resend lệnh','[-95047] - Trạng thái lệnh không hợp lệ, không thể resend lệnh','NFO',null);
INSERT INTO DEFERROR (ERRNUM,ERRDESC,EN_ERRDESC,MODCODE,CONFLVL)
...
INSERT INTO DEFERROR (ERRNUM,ERRDESC,EN_ERRDESC,MODCODE,CONFLVL)
VALUES (-95048,'[-95048] - Trạng thái lệnh không hợp lệ, không thể sửa lệnh!','[-95048] - Trạng thái lệnh không hợp lệ, không thể sửa lệnh!','NFO',null);
COMMIT;
/
