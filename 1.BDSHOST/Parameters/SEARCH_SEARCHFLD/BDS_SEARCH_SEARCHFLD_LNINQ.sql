...
--
/
DELETE SEARCH WHERE SEARCHCODE = 'LNINQ';
INSERT INTO SEARCH (SEARCHCODE,SEARCHTITLE,EN_SEARCHTITLE,SEARCHCMDSQL,OBJNAME,FRMNAME,ORDERBYCMDSQL,TLTXCD,CNTRECORD,ROWPERPAGE,AUTOSEARCH,INTERVAL,AUTHCODE,ROWLIMIT,CMDTYPE)
VALUES ('LNINQ','Tai khoan vay','Customer loan account management','SELECT MST.ACTYPE, MST.ACCTNO, A.CDCONTENT LNTYPE, MST.TRFACCTNO, CF.FULLNAME,
...
AND A.CDNAME = ''LNTYPE'' AND A.CDVAL = MST.LNTYPE AND 0=0 ','LNMAST','frmLNMAST',null,null,null,50,'N',30,null,'Y','T');
COMMIT;
/
