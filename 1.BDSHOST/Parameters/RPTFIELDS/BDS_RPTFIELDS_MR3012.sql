...
--
/
DELETE RPTFIELDS WHERE OBJNAME = 'MR3012';
...
VALUES ('MR','I_DATE','MR3012','I_DATE','Ngày giao dịch','In date',0,'M','99/99/9999','dd/MM/yyyy',10,null,null,'<$BUSDATE>','Y','N','Y',null,null,'N','D',null,null,null,null,null,null,null,null,null,null,null,null,'Y','T');
COMMIT;
/
