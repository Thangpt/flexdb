...
--
/
DELETE RPTFIELDS WHERE OBJNAME = 'CA0017';
...
VALUES ('CA','CACODE','CA0017','CACODE','Mã sự kiện CA','CA Code',1,'M','cccc.cccccc.cccccc','_',20,null,null,null,'Y','N','Y',null,null,'N','C',null,null,null,null,null,null,'CAMAST','CA',null,null,null,null,'Y','T');
COMMIT;
/
