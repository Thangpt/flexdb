...
--
/
DELETE RPTFIELDS WHERE OBJNAME = 'RM0051';
...
VALUES ('RM','PV_VOUCHER','RM0051','PV_VOUCHER','Chọn bảng kê','Voucher List',2,'M','CCCC/CC_CC/CCCCCC/CCC','_',21,null,null,null,'Y','N','Y',null,null,'N','C',null,null,null,null,null,null,'CRBVOUCHER','CI',null,null,null,null,'Y','T');
COMMIT;
/
