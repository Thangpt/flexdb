...
--
/
DELETE RPTFIELDS WHERE OBJNAME = 'SA0015';
...
VALUES ('SA','I_DATE','SA0015','I_DATE','Ngày giao dịch','On date',1,'M','99/99/9999','dd/MM/yyyy',10,null,null,'<$BUSDATE>','Y','N','Y',null,null,'N','D',null,null,null,null,null,null,null,null,null,null,null,null,'Y',null);
COMMIT;
/
