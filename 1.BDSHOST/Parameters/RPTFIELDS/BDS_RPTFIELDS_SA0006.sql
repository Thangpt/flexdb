...
--
/
DELETE RPTFIELDS WHERE OBJNAME = 'SA0006';
...
VALUES ('SA','AUTHID','SA0006','AUTHID','Mã nhóm người sử dụng','GroupID',0,'M','cccc','_',4,null,null,null,'Y','N','Y',null,null,'N','C',null,null,null,null,null,null,'TLGROUPS','SA',null,null,null,null,'Y','T');
COMMIT;
/
