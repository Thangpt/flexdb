--
/
DELETE rptfields WHERE objname='HDGDKQ';
...
values ('CF', 'PV_AUTOID', 'HDGDKQ', 'PV_AUTOID', 'Mã đăng ký', 'Auto Id', 1, 'M', 'ccccccccccc', '_', 10, null, null, null, 'Y', 'N', 'Y', null, null, 'N', 'C', null, null, null, null, null, null, 'CF4000', 'CF', null, null, null, null, 'Y', 'T');
COMMIT;
