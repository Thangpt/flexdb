...
--
/
DELETE RPTFIELDS WHERE OBJNAME = 'GL0035';
...
VALUES ('GL','I_DATE','GL0035','I_DATE','Ngày','In date',0,'M','99/99/9999','dd/MM/yyyy',10,null,null,'<$BUSDATE>','Y','N','Y',null,null,'N','D',null,null,null,null,null,null,null,null,null,null,null,null,'Y',null);
COMMIT;
/
