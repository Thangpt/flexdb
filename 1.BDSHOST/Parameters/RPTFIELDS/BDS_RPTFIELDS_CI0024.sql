...
--
/
DELETE RPTFIELDS WHERE OBJNAME = 'CI0024';
...
VALUES ('CI','TXNUM','CI0024','TXNUM','Mã HD ứng trước','TxNum',1,'M','CCCCCCCCCCCCCCCCCC','_',20,null,null,null,'Y','N','Y',null,null,'Y','C',null,null,null,null,null,null,'CIADINQ','CI',null,null,null,null,'Y','T');
COMMIT;
/
